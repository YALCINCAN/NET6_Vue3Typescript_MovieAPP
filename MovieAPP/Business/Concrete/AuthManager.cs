...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public AuthManager(UserManager<User> userManager, IMapper mapper, IEmailService emailService, IRefreshTokenService refreshTokenService, ITokenService tokenService, IHttpContextAccessor httpContextAccessor)
        {
