...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string UserRoleUpdated => "User role updated";

        // Comment Manager 

        public static string CommentNotYours => "The comment you want to delete is not yours";

        //Favorite Manager
        public static string AlreadyFavorited => "You have already favorited";
